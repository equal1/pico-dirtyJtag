...
# modified by Mircea Ionica <mircea.ionica@equal1.com>
# to add GIT_REMOTE extraction
...
function(GetGitState _working_dir)
    ...
    RunGitCommand(status --porcelain --ignore-submodules ${untracked_flag})
    ...
    execute_process(COMMAND
        ...
        OUTPUT_STRIP_TRAILING_WHITESPACE)
    if(NOT exit_code EQUAL 0)
        set(ENV{GIT_REMOTE} "unknown")
    else()
        set(ENV{GIT_REMOTE} "${output}")
    endif()
